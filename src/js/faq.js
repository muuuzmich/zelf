...
(function () {
    ...
    let section = null;
    let els = d.getElementsByClassName('faq__list__category__item__title');

    [].forEach.call(els, function (el) {
        el.addEventListener('click', (e) => {
            e.target.parentNode.classList.toggle('faq__list__category__item--opened');
    ...
    tocbot.init({
        orderedList: false,
        tocSelector: '.list-container',
        contentSelector: '.faq__list',
        listItemClass: 'category-list__item',
        activeLinkClass: 'active',
        linkClass: 'category-list__item__link',
